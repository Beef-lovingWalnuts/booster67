...
class B1LocoClient:
    ...
    def ChangeMode(self, mode: RobotMode) -> int:
        """
                         ...
                         */
        """
    def ControlDexterousHand(self, finger_params: list[DexterousFingerParameter], hand_index: B1HandIndex) -> int:
        """
                        /**
    ...
    def Move(self, vx: float, vy: float, vyaw: float) -> int:
        """
                         ...
                         */
        """
    def MoveHandEndEffector(self, target_posture: Posture, time_millis: int, hand_index: B1HandIndex) -> int:
        """
                        /**
                         ...
                         */
        """
    def MoveHandEndEffectorV2(self, target_posture: Posture, time_millis: int, hand_index: B1HandIndex) -> int:
        """
                        /**
                         *  @brief Move hand end-effector with a target posture(position & orientation)
                         *
                         ...
                         */
        """
    def MoveHandEndEffectorWithAux(self, target_posture: Posture, aux_posture: Posture, time_millis: int, hand_index: B1HandIndex) -> int:
        """
                        /**
